...
#[UniqueEntity(
    fields: ['email'],
    errorPath: 'error_email',
    message: 'Il existe déjà un compte avec cet email')]
#[UniqueEntity(
    fields: ['pseudo'],
    errorPath: 'error_pseudo',
    message: 'Il existe déjà un compte avec ce pseudo')]
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Novels::class, inversedBy: 'favoris')]
    ...
    public function addFavori(Novels $favori): static
    {
    ...
    public function removeFavori(Novels $favori): static
    {
    ...
    public function setDefaultImageIfEmpty()
    {
        if (empty($this->imageName)) {
            $this->imageName = 'public/images/user/inconnu.jpg';
        }
    }
